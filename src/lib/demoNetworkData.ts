...
export const DEMO_WIDGET_DATA = {
  ...
  connections: [
    ...
    },
    {
      id: "noah",
      name: "Noah Kim",
      bio: "UX Writer at Linear.",
      website: "noahkim.co",
      avatar_url: null,
      relationship: "I worked with Noah on rewriting our onboarding copy.",
      endorsesOwner: false,
      endorsements: [],
      workSamples: [workSample("w14", 4), workSample("w15", 2)],
    },
    {
      id: "ivy",
      name: "Ivy Novak",
    ...
    },
    {
      id: "theo",
      name: "Theo Bennett",
      bio: "Brand Designer at Stripe.",
      website: "theobennett.design",
      avatar_url: null,
      relationship: "I worked with Theo on our full brand refresh last year.",
      endorsesOwner: false,
      endorsements: [],
      workSamples: [workSample("w20", 3, true), workSample("w21", 4)],
    },
    {
      id: "zara",
      name: "Zara Ahmed",
      bio: "Product Manager at Notion.",
      website: "zaraahmed.co",
      avatar_url: null,
      relationship: "Zara and I shipped three releases together as PM and design lead.",
      endorsesOwner: true,
      endorsements: [],
      workSamples: [workSample("w22", 0)],
    },
    {
      id: "felix",
      name: "Felix Grant",
      bio: "Illustrator, freelance.",
      website: "felixgrant.art",
      avatar_url: null,
      relationship: "I worked with Felix on a set of editorial illustrations for the blog.",
      endorsesOwner: false,
      endorsements: [],
      workSamples: [workSample("w23", 5), workSample("w24", 6), workSample("w25", 2)],
    },
    {
      id: "ruby",
      name: "Ruby Santos",
      bio: "Design Systems Lead at Vercel.",
      website: "rubysantos.dev",
      avatar_url: null,
      relationship: "Ruby and I built out the design system components side by side.",
      endorsesOwner: true,
      endorsements: [
        {
          id: "e5",
          ...
          fromName: "Jordan Lee",
          fromAvatarUrl: null,
          text: "Ruby's systems thinking makes every team around her faster.",
        },
      ],
      workSamples: [workSample("w26", 7), workSample("w27", 1)],
    },
  ],
};
